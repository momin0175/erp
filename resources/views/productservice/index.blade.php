...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ route('productservice.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-original-title="{{__('Create')}}" data-title="{{__('Create New Product')}}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($productServices as $productService)
                                <tr class="font-style">
                                    ...
                                    <td>{{ number_format($productService->sale_price, 2) }}</td>
                                    <td>{{ number_format($productService->purchase_price, 2 )}}</td>
